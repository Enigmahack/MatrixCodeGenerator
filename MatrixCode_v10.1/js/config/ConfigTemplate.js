...
const QuantizedInheritableSettings = [
    ...
    { sub: 'Line Appearance', id: 'LineGfxColor', type: 'color', label: 'Color', tier: 'basic', description: 'The primary color of the grid lines.', tags: ['color', 'tint', 'hue'] },
    { sub: 'Line Appearance', id: 'GlassRefractionOpacity', type: 'range', label: 'Opacity', min: 0.0, max: 1.0, step: 0.01, tier: 'basic', description: "Overall opacity of the refraction lines. 1 is fully opaque, 0 is fully transparent.", tags: ['alpha', 'transparency'], unit: '%', transform: v => (v * 100).toFixed(0) + '%' },
    { sub: 'Line Appearance', id: 'LineGfxPersistence', type: 'range', label: 'Persistence', min: 1, max: 180, step: 1, unit: 'fr', tier: 'advanced', description: "Controls how long lines linger after the effect retracts. Similar to burn-in.", tags: ['trail', 'fade', 'length'] },

    { sub: 'Line Appearance', sub_header: 'Perimeter', id: 'GlassRefractionEnabled', type: 'checkbox', label: 'Enable Perimeter', tier: 'basic', description: "Adds a light-refraction highlight centered on block edges.", tags: ['glass', 'bend', 'light', 'perimeter', 'lines'] },
    { sub: 'Line Appearance', id: 'TriggerBrightnessSwell', type: 'checkbox', label: 'Trigger Brightness Swell', dep: 'GlassRefractionEnabled', tier: 'advanced', description: "When enabled, line brightness swells to max initially.", tags: ['swell', 'brightness'] },
    { sub: 'Line Appearance', id: 'IncludeSwellPause', type: 'checkbox', label: 'Include Swell Pause', dep: ['GlassRefractionEnabled', 'TriggerBrightnessSwell'], tier: 'advanced', description: "Pauses animation initially while the brightness swell occurs.", tags: ['swell', 'pause', 'timing'] },
    { sub: 'Line Appearance', id: 'GlassRefractionWidth', type: 'range', label: 'Width', min: 0.0, max: 1.0, step: 0.01, dep: 'GlassRefractionEnabled', tier: 'advanced', description: "Width of the refraction band as a fraction of cell size.", tags: ['size', 'width'], unit: '%', transform: v => (v * 100).toFixed(0) + '%' },
    { sub: 'Line Appearance', id: 'GlassRefractionBrightness', type: 'range', label: 'Brightness Start', min: 0.0, max: 3.0, step: 0.05, dep: 'GlassRefractionEnabled', tier: 'advanced', description: "Brightness of the refraction edge highlight at the beginning.", tags: ['light', 'bright', 'start'], unit: '%', transform: v => (v * 100).toFixed(0) + '%' },
    { sub: 'Line Appearance', id: 'GlassRefractionBrightnessEnd', type: 'range', label: 'Brightness End', min: 0.0, max: 3.0, step: 0.05, dep: 'GlassRefractionEnabled', tier: 'advanced', description: "Target brightness at the end of the effect.", tags: ['light', 'bright', 'end'], unit: '%', transform: v => (v * 100).toFixed(0) + '%' },
    ...
    { sub: 'Line Appearance', id: 'GlassRefractionGlow', type: 'range', label: 'Glow', min: 0.0, max: 2.0, step: 0.05, dep: 'GlassRefractionEnabled', tier: 'advanced', description: "Additive glow emission at the refraction peak.", tags: ['bloom', 'glow'], unit: '%', transform: v => (v * 100).toFixed(0) + '%' },
    ...
    { sub: 'Line Appearance', sub_header: 'Random Dimming', id: 'LineGfxBrightnessVarianceEnabled', type: 'checkbox', label: 'Enable Random Dimming', tier: 'advanced', description: "Applies random brightness variations to individual line segments.", tags: ['random', 'flicker', 'variety'] },
    ...
    { sub: 'Line Appearance', id: 'LineGfxBrightnessVarianceCoverage', type: 'range', label: 'Affected Segments', min: 0, max: 100, step: 5, unit: '%', dep: 'LineGfxBrightnessVarianceEnabled', tier: 'advanced', description: "Percentage of rows/columns affected by the dimming.", tags: ['random', 'area'] },
    { sub: 'Line Appearance', id: 'LineGfxBrightnessVarianceDirection', type: 'range', label: 'Direction', min: 0, max: 2, step: 1, dep: 'LineGfxBrightnessVarianceEnabled', tier: 'advanced', transform: v => ['H', 'Mixed', 'V'][v] ?? 'Mixed', description: "H = horizontal lines only, Mixed = both, V = vertical lines only.", tags: ['direction', 'axis'] },
    ...
    { sub: 'Line Fine-Tuning', id: 'LineGfxMaskSoftness', type: 'range', label: 'Softness', min: 0.0, max: 5.0, step: 0.1, tier: 'advanced', description: 'Controls the blurriness of the character highlights inside the grid lines.', tags: ['blur', 'soft', 'smooth'] },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', sub_header: 'Perimeter Spawner', id: 'BlockSpawnerEnabled', type: 'checkbox', label: 'Enable Spawner', tier: 'advanced', description: "Randomly spawns and despawns blocks outside the main edge.", tags: ['spawn', 'despawn'] },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'BlockSpawnerBehaviorType', type: 'select', label: 'Behavior Type', options: [{label: 'Core (Every Step)', value: 'core'}, {label: 'Pool (Scheduled)', value: 'pool'}], dep: 'BlockSpawnerEnabled', tier: 'advanced' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'BlockSpawnerGrowthMode', type: 'select', label: 'Growth Mode', options: [{label: 'Edge (Outermost)', value: 'edge'}, {label: 'Spine (Initial)', value: 'spine'}], dep: 'BlockSpawnerEnabled', tier: 'advanced' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'BlockSpawnerSpawnBias', type: 'select', label: 'Spawn Bias', options: [{label: 'Smaller', value: 'smaller'}, {label: 'Larger', value: 'larger'}], dep: 'BlockSpawnerEnabled', tier: 'advanced', description: 'Smaller favors 1x1 and 1x2 blocks. Larger favors 1x3, 1x4, and 2x2 blocks.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'BlockSpawnerStartDelay', type: 'range', label: 'Start Delay', min: 0, max: 100, step: 1, dep: 'BlockSpawnerEnabled', tier: 'advanced' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'BlockSpawnerRate', type: 'range', label: 'Spawn Rate', min: 1, max: 50, step: 1, dep: 'BlockSpawnerEnabled', tier: 'advanced', description: 'How often the spawner attempts to place new blocks.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'BlockSpawnerCount', type: 'range', label: 'Max Spawns per Rate', min: 1, max: 20, step: 1, dep: 'BlockSpawnerEnabled', tier: 'advanced', description: 'Maximum number of blocks created per spawning event.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'BlockSpawnerDespawnRate', type: 'range', label: 'Despawn Rate', min: 1, max: 50, step: 1, dep: 'BlockSpawnerEnabled', tier: 'advanced', description: 'How often the spawner attempts to remove existing blocks.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'BlockSpawnerStopAfter', type: 'range', label: 'Stop After', min: 0, max: 100, step: 1, unit: 'steps', dep: 'BlockSpawnerEnabled', tier: 'advanced', description: 'Prevents the behavior from growing after this many steps. 0 = never stops.', tags: ['stop', 'limit', 'end'] },

    { sub: 'V2 Generator (Spawn Behaviors)', sub_header: 'Explorer Growth', id: 'NudgeEnabled', type: 'checkbox', label: 'Enable Explorer Growth', tier: 'advanced', description: "Enables explorers that move towards screen edges.", tags: ['explorer', 'nudge'] },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'ExplorerMaxCount', type: 'range', label: 'Max Number of Explorers', min: 1, max: 100, step: 1, dep: 'NudgeEnabled', tier: 'advanced' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'ExplorerSpawnRate', type: 'range', label: 'Steps per Spawn', min: 1, max: 20, step: 1, dep: 'NudgeEnabled', tier: 'advanced' },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'NudgeStopAfter', type: 'range', label: 'Stop After', min: 0, max: 100, step: 1, unit: 'steps', dep: 'NudgeEnabled', tier: 'advanced', description: 'Prevents the behavior from growing after this many steps. 0 = never stops.', tags: ['stop', 'limit', 'end'] },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'NudgeChance', type: 'range', label: 'Explorer Chance', min: 0.1, max: 1.0, step: 0.1, dep: 'NudgeEnabled', tier: 'advanced', unit: '%', transform: v => (v * 100).toFixed(0) + '%', description: 'The probability of a growth nudge occurring at each step.' },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'SpreadingNudgeStopAfter', type: 'range', label: 'Stop After', min: 0, max: 100, step: 1, unit: 'steps', dep: 'SpreadingNudgeEnabled', tier: 'advanced', description: 'Prevents the behavior from growing after this many steps. 0 = never stops.', tags: ['stop', 'limit', 'end'] },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'SpreadingNudgeSpawnSpeed', type: 'range', label: 'Spawn Speed', min: 1, max: 10, step: 1, dep: 'SpreadingNudgeEnabled', tier: 'advanced', description: 'The travel speed of spreading nudges.', invert: true, transform: v => v <= 2 ? 'Faster' : (v >= 9 ? 'Slower' : v) },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'SpreadingNudgeMaxInstances', type: 'range', label: 'Max Explorer Instances', min: 1, max: 100, step: 1, dep: 'SpreadingNudgeEnabled', tier: 'advanced', description: 'Maximum number of concurrent spreading nudges.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'SpreadingNudgeRange', type: 'range', label: 'Explorer Spread Range', min: 5, max: 100, step: 5, dep: 'SpreadingNudgeEnabled', tier: 'advanced', unit: '%', transform: v => v + '%', description: 'Maximum distance arms extend, as a percentage of screen dimensions.' },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', sub_header: 'Block Filler', id: 'ShoveFillEnabled', type: 'checkbox', label: 'Enable Block Filler', tier: 'advanced', description: "Fills gaps by pushing strips outward from existing blocks.", tags: ['fill', 'block'] },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'ShoveFillAmount', type: 'range', label: 'Fill Amount', min: 1, max: 5, step: 1, dep: 'ShoveFillEnabled', tier: 'advanced', description: 'Maximum number of blocks placed during a fill event.' },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'HoleFillerStopAfter', type: 'range', label: 'Stop After', min: 0, max: 100, step: 1, unit: 'steps', dep: 'HoleFillerEnabled', tier: 'advanced', description: 'Prevents the behavior from growing after this many steps. 0 = never stops.', tags: ['stop', 'limit', 'end'] },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'BlockThickenStopAfter', type: 'range', label: 'Stop After', min: 0, max: 100, step: 1, unit: 'steps', dep: 'BlockThickenEnabled', tier: 'advanced', description: 'Prevents the behavior from growing after this many steps. 0 = never stops.', tags: ['stop', 'limit', 'end'] },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'BlockThickenMaxBlocks', type: 'range', label: 'Max Blocks per Side', min: 1, max: 20, step: 1, dep: 'BlockThickenEnabled', tier: 'advanced', description: 'Maximum number of blocks added per side when thickening. Limits runaway widening along long axes.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'BlockThickenQuadrantEnabled', type: 'checkbox', label: 'Quadrant Thicken', dep: 'BlockThickenEnabled', tier: 'advanced', description: 'Adds a 1-block thick layer to the perimeter of all blocks within a chosen quadrant.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'BlockThickenMultiQuadrantChance', type: 'range', label: 'Multi-Quadrant Chance', min: 0, max: 100, step: 1, dep: ['BlockThickenEnabled', 'BlockThickenQuadrantEnabled'], tier: 'advanced', unit: '%' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'BlockThickenQuadrantRampUp', type: 'checkbox', label: 'Quadrant Ramp-up', dep: ['BlockThickenEnabled', 'BlockThickenQuadrantEnabled'], tier: 'advanced', description: 'Actual chance ramps up to the max value based on screen fill percentage.' },

    { sub: 'V2 Generator (Spawn Behaviors)', sub_header: 'Trace Thicken', id: 'TraceThickenEnabled', type: 'checkbox', label: 'Enable Trace Thicken', tier: 'advanced', description: "Identifies straight 'tendrils' and thickens them by nudging the entire path outward.", tags: ['trace', 'thicken', 'tendril'] },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'TraceThickenBehaviorType', type: 'select', label: 'Behavior Type', options: [{label: 'Core (Every Step)', value: 'core'}, {label: 'Pool (Scheduled)', value: 'pool'}], dep: 'TraceThickenEnabled', tier: 'advanced' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'TraceThickenGrowthMode', type: 'select', label: 'Growth Mode', options: [{label: 'Edge (Outermost)', value: 'edge'}, {label: 'Spine (Initial)', value: 'spine'}], dep: 'TraceThickenEnabled', tier: 'advanced' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'TraceThickenStartDelay', type: 'range', label: 'Start Delay', min: 0, max: 100, step: 1, dep: 'TraceThickenEnabled', tier: 'advanced' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'TraceThickenStopAfter', type: 'range', label: 'Stop After', min: 0, max: 100, step: 1, unit: 'steps', dep: 'TraceThickenEnabled', tier: 'advanced', description: 'Prevents the behavior from growing after this many steps. 0 = never stops.', tags: ['stop', 'limit', 'end'] },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'TraceThickenChance', type: 'range', label: 'Trace Chance (%)', min: 1, max: 100, step: 1, dep: 'TraceThickenEnabled', tier: 'advanced', unit: '%', description: 'Probability of a trace event occurring.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'TraceThickenFrequency', type: 'range', label: 'Trace Frequency', min: 1, max: 50, step: 1, dep: 'TraceThickenEnabled', tier: 'advanced', description: 'Steps between trace attempts.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'TraceThickenMaxDepth', type: 'range', label: 'Max Trace Depth', min: 1, max: 30, step: 1, dep: 'TraceThickenEnabled', tier: 'advanced', description: 'Maximum distance back toward the axis to trace a tendril.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'TraceThickenWidth', type: 'range', label: 'Thickness', min: 1, max: 9, step: 2, dep: 'TraceThickenEnabled', tier: 'advanced', description: 'The width of the nudged area (e.g., 3 means the tendril and 1 neighbor on each side). Disallows even numbers.' },

    { sub: 'V2 Generator (Spawn Behaviors)', sub_header: 'Fill Crawler', id: 'FillCrawlerEnabled', type: 'checkbox', label: 'Enable Fill Crawler', tier: 'advanced', description: "Spawns 'snail-like' crawlers that explore and nudge outward from the spine or edges.", tags: ['crawl', 'fill', 'snail'] },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'FillCrawlerBehaviorType', type: 'select', label: 'Behavior Type', options: [{label: 'Core (Every Step)', value: 'core'}, {label: 'Pool (Scheduled)', value: 'pool'}], dep: 'FillCrawlerEnabled', tier: 'advanced' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'FillCrawlerGrowthMode', type: 'select', label: 'Growth Mode', options: [{label: 'Edge (Outermost)', value: 'edge'}, {label: 'Spine (Initial)', value: 'spine'}], dep: 'FillCrawlerEnabled', tier: 'advanced' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'FillCrawlerStartDelay', type: 'range', label: 'Start Delay', min: 0, max: 100, step: 1, dep: 'FillCrawlerEnabled', tier: 'advanced' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'FillCrawlerStopAfter', type: 'range', label: 'Stop After', min: 0, max: 100, step: 1, unit: 'steps', dep: 'FillCrawlerEnabled', tier: 'advanced', description: 'Prevents the behavior from growing after this many steps. 0 = never stops.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'FillCrawlerCount', type: 'range', label: 'Max Crawlers', min: 1, max: 20, step: 1, dep: 'FillCrawlerEnabled', tier: 'advanced' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'FillCrawlerRate', type: 'range', label: 'Spawn Rate', min: 1, max: 50, step: 1, dep: 'FillCrawlerEnabled', tier: 'advanced', description: 'Steps between new crawler spawns.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'FillCrawlerChance', type: 'range', label: 'Activity Chance (%)', min: 1, max: 100, step: 1, dep: 'FillCrawlerEnabled', tier: 'advanced', unit: '%' },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'InsideOutStopAfter', type: 'range', label: 'Stop After', min: 0, max: 100, step: 1, unit: 'steps', dep: 'InsideOutEnabled', tier: 'advanced', description: 'Prevents the behavior from growing after this many steps. 0 = never stops.', tags: ['stop', 'limit', 'end'] },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'InsideOutGrowthMode', type: 'select', label: 'Growth Mode', options: [{label: 'Spine (Axes Only)', value: 'spine'}, {label: 'Edge (Mass Frontier)', value: 'edge'}], dep: 'InsideOutEnabled', tier: 'advanced', description: 'Controls where the inside-out expansion waves originate from.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'InsideOutSpawnBias', type: 'select', label: 'Spawn Bias', options: [{label: 'Single Strip', value: 'single'}, {label: 'Wider', value: 'wider'}], dep: 'InsideOutEnabled', tier: 'advanced' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'InsideOutBlockWidth', type: 'range', label: 'Block Width', min: 1, max: 4, step: 1, dep: 'InsideOutEnabled', tier: 'advanced', description: 'Width of blocks spawned by inside-out expansion strips.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'InsideOutBlockHeight', type: 'range', label: 'Block Height', min: 1, max: 4, step: 1, dep: 'InsideOutEnabled', tier: 'advanced', description: 'Height of blocks spawned by inside-out expansion strips.' },
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'InsideOutSnapToEdges', type: 'checkbox', label: 'Snap to Edges', dep: 'InsideOutEnabled', tier: 'advanced', description: 'When enabled, the generator will attempt to snap blocks to the screen edges once they are close enough.' },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'AxisShiftStopAfter', type: 'range', label: 'Stop After', min: 0, max: 100, step: 1, unit: 'steps', dep: 'AxisShiftEnabled', tier: 'advanced', description: 'Prevents the behavior from growing after this many steps. 0 = never stops.', tags: ['stop', 'limit', 'end'] },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'AxisShiftMaxLength', type: 'range', label: 'Max Strip Length', min: 0, max: 100, step: 1, dep: 'AxisShiftEnabled', tier: 'advanced', description: 'Maximum block length allowed before a strip is despawned and a new one is placed. 0 = unlimited.' },
...
const ConfigTemplate = [
    ...
    { cat: 'Effects', type: 'sub_accordion', label: 'Shader Glimmer' },
    { cat: 'Effects', id: 'shaderGlimmerEnabled', type: 'checkbox', label: 'Enable Glimmer', tier: 'basic', description: 'Adds a procedural, scrolling glimmer/shine effect to active code characters, rendered on the GPU.', tags: ['shine', 'highlight', 'glint'] },
    { cat: 'Effects', id: 'shaderGlimmerSpeed', type: 'range', label: 'Speed', min: 0.0, max: 0.5, step: 0.01, dep: 'shaderGlimmerEnabled', tier: 'advanced', description: 'The vertical scrolling speed and shimmer/flicker frequency of the glimmer effect.', tags: ['fast', 'slow', 'motion', 'flicker'] },
    { cat: 'Effects', id: 'shaderGlimmerDensity', type: 'range', label: 'Density', min: 0.0, max: 1.0, step: 0.01, dep: 'shaderGlimmerEnabled', tier: 'advanced', description: 'The percentage of the screen covered by glimmer highlights.', tags: ['amount', 'coverage'], unit: '%', transform: v => (v * 100).toFixed(0) + '%' },
    { cat: 'Effects', id: 'shaderGlimmerIntensity', type: 'range', label: 'Intensity', min: 0.0, max: 2.0, step: 0.05, dep: 'shaderGlimmerEnabled', tier: 'basic', description: 'The brightness of the glimmer highlights.', tags: ['bright', 'shine'] },
    { cat: 'Effects', id: 'shaderGlimmerColor', type: 'color', label: 'Color', dep: 'shaderGlimmerEnabled', tier: 'advanced', description: 'The tint of the glimmer effect.', tags: ['tint', 'hue'] },
    { cat: 'Effects', id: 'shaderGlimmerVerticalSpeed', type: 'range', label: 'Vertical Speed', min: 0.0, max: 20.0, step: 0.1, dep: 'shaderGlimmerEnabled', tier: 'advanced', description: 'How fast the glimmer band moves upward (cells/sec). Set to 0 to disable vertical band movement.', tags: ['motion', 'sweep', 'band'] },
    { cat: 'Effects', id: 'shaderGlimmerHeight', type: 'range', label: 'Height', min: 1, max: 50, step: 1, dep: 'shaderGlimmerEnabled', tier: 'advanced', description: 'How many character rows the active glimmer band spans.', tags: ['band', 'size', 'rows'] },
    { cat: 'Effects', id: 'shaderGlimmerFadeOut', type: 'range', label: 'Fade Out', min: 0, max: 120, step: 1, dep: 'shaderGlimmerEnabled', tier: 'advanced', description: 'Frames for the glimmer trail to dim after the band passes.', tags: ['trail', 'dim', 'fade'] },
    { cat: 'Effects', type: 'end_group' },

    { cat: 'Effects', type: 'sub_accordion', label: 'Glow Blocks' },
    { cat: 'Effects', id: 'glowBlocksEnabled', type: 'checkbox', label: 'Enable Glow Blocks', tier: 'basic', description: 'Invisible floating blocks that boost and tint underlying code.', tags: ['float', 'glow', 'block', 'tint'] },
    { cat: 'Effects', type: 'accordion_subheader', label: 'Behavior', dep: 'glowBlocksEnabled' },
    { cat: 'Effects', id: 'glowBlocksFrequency', type: 'range', label: 'Frequency', min: 0, max: 1.0, step: 0.01, unit: '%', transform: v => (v * 100).toFixed(0) + '%', dep: 'glowBlocksEnabled', tier: 'advanced', description: "The chance that the full density of blocks will be active at any given time.", tags: ['chance', 'spawn'] },
    { cat: 'Effects', id: 'glowBlocksDensity', type: 'range', label: 'Density', min: 1, max: 50, step: 1, dep: 'glowBlocksEnabled', tier: 'basic', description: 'The target number of glowing highlight blocks on screen.', tags: ['amount', 'count'] },
    { cat: 'Effects', id: 'glowBlocksSpeed', type: 'range', label: 'Speed', min: 0.01, max: 1.0, step: 0.01, unit: '%', transform: v => (v * 100).toFixed(0) + '%', dep: 'glowBlocksEnabled', description: 'How fast the highlight blocks move across the grid.', tags: ['motion', 'fast'] },
    { cat: 'Effects', id: 'glowBlocksArea', type: 'range', label: 'Max Area', min: 1, max: 64, step: 1, unit: 'cl', dep: 'glowBlocksEnabled', tier: 'advanced', description: 'Maximum size of a single highlight block in grid cells.', tags: ['size', 'volume'] },
    { cat: 'Effects', id: 'glowBlocksAllowShapes', type: 'checkbox', label: 'Allow Irregular Shapes', dep: 'glowBlocksEnabled', tier: 'advanced', description: "Enables organic, edge-connected growth for more complex block forms.", tags: ['random', 'form'] },
    { cat: 'Effects', type: 'accordion_subheader', label: 'Look', dep: 'glowBlocksEnabled' },
    { cat: 'Effects', id: 'glowBlocksIntensity', type: 'range', label: 'Intensity', min: 0.0, max: 2.0, step: 0.05, dep: 'glowBlocksEnabled', tier: 'basic', description: 'Overall brightness multiplier for highlight blocks.', tags: ['strength', 'power'], unit: '%', transform: v => (v * 100).toFixed(0) + '%' },
    { cat: 'Effects', id: 'glowBlocksLuminanceBoost', type: 'range', label: 'Luminance Boost', min: 0.0, max: 5.0, step: 0.1, dep: 'glowBlocksEnabled', tier: 'advanced', description: 'Extra brightness for characters covered by a highlight block.', tags: ['bright', 'light'] },
    { cat: 'Effects', id: 'glowBlocksStaticColorEnabled', type: 'checkbox', label: 'Static Color', dep: 'glowBlocksEnabled', tier: 'basic', description: "Use a single fixed color for all blocks instead of randomizing per-block.", tags: ['fixed', 'set'] },
    { cat: 'Effects', id: 'glowBlocksStaticColor', type: 'color', label: 'Block Color', dep: ['glowBlocksEnabled', 'glowBlocksStaticColorEnabled'], tier: 'basic', description: "The color used for all blocks when Static Color is enabled.", tags: ['tint', 'hue'] },
    { cat: 'Effects', id: 'glowBlocksTintInfluence', type: 'range', label: 'Tint Influence', min: 0, max: 100, unit: '%', dep: 'glowBlocksEnabled', tier: 'advanced', description: "How strongly the block color blends with the underlying code (0% = Original Only).", tags: ['color', 'hue'] },
    { cat: 'Effects', id: 'glowBlocksFadeRate', type: 'range', label: 'Fade Rate', min: 0.0, max: 1.0, step: 0.01, dep: 'glowBlocksEnabled', tier: 'advanced', description: 'How quickly the highlight fades after a block moves.', tags: ['decay', 'trail', 'linger'], unit: '%', transform: v => (v * 100).toFixed(0) + '%' },
    { cat: 'Effects', type: 'end_group' },

class MiniPulseEffect extends AbstractEffect {
            ...
            update() {
                ...
                for (let i = this.pulses.length - 1; i >= 0; i--) { 
                    ...
                    // --- OPTIMIZATION START ---
                    // Pre-calculate pixel coordinates and bounds for this frame
                    const ox = (p.x * d.cellWidth * s.stretchX);
                    const oy = (p.y * d.cellHeight * s.stretchY);
            ...
            getOverride(i) {
                ...
                // Pixel coordinates of the current cell

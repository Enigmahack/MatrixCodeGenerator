class UIManager {
    ...
    _generateBehaviorSettings() {
        return [
            ...
            { cat: 'Behavior', type: 'accordion_subheader', label: 'Upward Tracers'},
            { cat: 'Behavior', id: 'upwardTracerEnabled', type: 'checkbox', label: 'Upward Tracers', description: 'Invisible scanners that light up existing code' },
            { cat: 'Behavior', id: 'upwardTracerChance', type: 'range', label: 'Upward Rate', min: 0, max: 0.2, step: 0.01, dep: 'upwardTracerEnabled' },
            { cat: 'Behavior', id: 'upwardTracerAttackFrames', type: 'range', label: 'Fade In', min: 0, max: 20, unit: 'fr', dep: 'upwardTracerEnabled' },
            { cat: 'Behavior', id: 'upwardTracerHoldFrames', type: 'range', label: 'Hold', min: 0, max: 20, unit: 'fr', dep: 'upwardTracerEnabled' },
            { cat: 'Behavior', id: 'upwardTracerReleaseFrames', type: 'range', label: 'Fade Out', min: 0, max: 20, unit: 'fr', dep: 'upwardTracerEnabled' },
            { cat: 'Behavior', id: 'upwardTracerSpeedMult', type: 'range', label: 'Speed Multiplier', min: 0.5, max: 4.0, step: 0.1, transform: v=>v+'x', dep: 'upwardTracerEnabled' },
            { cat: 'Behavior', id: 'upwardTracerGlimmerChance', type: 'range', label: 'Glimmer Chance', min: 0, max: 1.0, step: 0.05, transform: v=>(v*100).toFixed(0)+'%', dep: 'upwardTracerEnabled' },
            { cat: 'Behavior', id: 'upwardTracerGlimmerSpeed', type: 'range', label: 'Glimmer Blink Speed', min: 0.1, max: 10.0, step: 0.1, dep: 'upwardTracerEnabled' },
            { cat: 'Behavior', id: 'upwardTracerGlimmerSize', type: 'range', label: 'Glimmer Spot Size', min: 0.1, max: 1.0, step: 0.05, dep: 'upwardTracerEnabled' },

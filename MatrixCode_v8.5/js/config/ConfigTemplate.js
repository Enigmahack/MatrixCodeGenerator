...
const generateQuantizedEffectSettings = (prefix, label, action) => {
    const settings = [
        ...
        { cat: 'Effects', id: prefix + "GeneratorTakeover", type: 'checkbox', label: 'Generator Takeover', dep: prefix + "Enabled", description: "When the animation reaches the last step, the Block Generator (V2) will take over and continue growing the effect procedurally." },
...
const ConfigTemplate = [
    ...
    { cat: 'Effects', id: 'quantizedGenerateV2AllowAsymmetry', type: 'checkbox', label: 'Allow Asymmetry', dep: 'quantizedGenerateV2Enabled', description: 'Allow deferred columns/rows for unpredictable, non-symmetric growth patterns.' },
    { cat: 'Effects', id: 'quantizedGenerateV2GenerativeScaling', type: 'checkbox', label: 'Generative Scaling', dep: 'quantizedGenerateV2Enabled', description: 'Scales the number of growth events per step based on the available opportunities. Prevents overcrowding in dense areas while maintaining growth in sparse areas.' },

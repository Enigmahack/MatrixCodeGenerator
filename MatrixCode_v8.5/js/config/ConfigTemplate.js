...
const ConfigTemplate = [
    ...
    { cat: 'Appearance', id: 'glowBlocksSpeed', type: 'range', label: 'Speed', min: 0.01, max: 1.0, step: 0.01, unit: '%', transform: v => (v * 100).toFixed(0) + '%', dep: 'glowBlocksEnabled', description: 'How fast the highlight blocks move across the grid.', tags: ['motion', 'fast'] },
    ...
    { cat: 'Appearance', id: 'glowBlocksStaticColor', type: 'color', label: 'Block Color', dep: ['glowBlocksEnabled', 'glowBlocksStaticColorEnabled'], tier: 'basic', description: "The color used for all blocks when Static Color is enabled.", tags: ['tint', 'hue'] },

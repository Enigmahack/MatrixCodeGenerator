...
const generateQuantizedEffectSettings = (prefix, label, action) => [
    ...
    { cat: 'Effects', type: 'button', label: 'Open Effect Editor', action: 'openEditor', class: 'btn-info', dep: prefix + "Enabled" },
...
const ConfigTemplate = [
    ...
    { cat: 'Debug', type: 'accordion_header', label: 'Glass Rendering' },
    { cat: 'Debug', id: 'quantizedGlassEnabled', type: 'checkbox', label: 'Enable Glass Rendering', description: "Uses a GLSL-based composition shader for line rendering, replacing the standard line system." },
    { cat: 'Debug', id: 'quantizedGlassBodyOpacity', type: 'range', label: 'Body Opacity', min: 0.0, max: 1.0, step: 0.05, dep: 'quantizedGlassEnabled' },
    { cat: 'Debug', id: 'quantizedGlassEdgeGlow', type: 'range', label: 'Edge Glow', min: 1.0, max: 20.0, step: 0.1, dep: 'quantizedGlassEnabled' },
    { cat: 'Debug', id: 'quantizedGlassRefraction', type: 'range', label: 'Refraction Strength', min: 0.0, max: 0.1, step: 0.005, dep: 'quantizedGlassEnabled' },
    { cat: 'Debug', id: 'quantizedGlassChromaticAberration', type: 'range', label: 'Chromatic Aberration', min: 0.0, max: 0.05, step: 0.005, dep: 'quantizedGlassEnabled' },
    { cat: 'Debug', id: 'quantizedGlassFresnel', type: 'range', label: 'Fresnel Strength', min: 0.0, max: 5.0, step: 0.1, dep: 'quantizedGlassEnabled' },
    { cat: 'Debug', id: 'quantizedGlassBevel', type: 'range', label: 'Specular Bevel', min: 0.0, max: 2.0, step: 0.1, dep: 'quantizedGlassEnabled' },
    { cat: 'Debug', type: 'accordion_subheader', label: 'Layer Stacking', dep: 'quantizedGlassEnabled' },
    { cat: 'Debug', id: 'quantizedGlassOverlapRefraction', type: 'range', label: 'Stacking: Refraction Multiplier', min: 0.0, max: 2.0, step: 0.1, dep: 'quantizedGlassEnabled', description: "Scales refraction strength for each additional glass layer." },
    { cat: 'Debug', id: 'quantizedGlassOverlapGlow', type: 'range', label: 'Stacking: Glow Multiplier', min: 0.0, max: 2.0, step: 0.1, dep: 'quantizedGlassEnabled', description: "Scales edge glow brightness for each additional glass layer." },
    { cat: 'Debug', id: 'quantizedGlassOverlapOpacity', type: 'range', label: 'Stacking: Opacity Multiplier', min: 0.0, max: 2.0, step: 0.1, dep: 'quantizedGlassEnabled', description: "Scales glass body opacity for each additional glass layer." },
    { cat: 'Debug', type: 'accordion_subheader', label: 'Transmission', dep: 'quantizedGlassEnabled' },
    { cat: 'Debug', id: 'quantizedGlassBloom', type: 'range', label: 'Interior Brightness', min: 1.0, max: 5.0, step: 0.1, dep: 'quantizedGlassEnabled' },
    { cat: 'Debug', id: 'quantizedGlassLensCurvature', type: 'range', label: 'Lens Curvature', min: 0.0, max: 3.0, step: 0.1, dep: 'quantizedGlassEnabled' },
    { cat: 'Debug', id: 'quantizedGlassDarkness', type: 'range', label: 'Background Darkness', min: 0.0, max: 1.0, step: 0.05, dep: 'quantizedGlassEnabled' },

...
const ConfigTemplate = [
    ...
    { cat: 'Effects', type: 'accordion_subheader', label: 'Spawn Spreader', dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2Enabled'] },
    { cat: 'Effects', id: 'quantizedGenerateV2SpawnSpreaderEnabled', type: 'checkbox', label: 'Enabled', dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2Enabled'], tier: 'advanced', description: 'When enabled, periodically spawns new growth behaviors at random locations along the axes.', tags: ['spawn', 'spreader'] },
    { cat: 'Effects', id: 'quantizedGenerateV2SpawnSpreaderStartDelay', type: 'range', label: 'Start Delay', min: 0, max: 100, step: 1, unit: 'steps', dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2SpawnSpreaderEnabled'], tier: 'advanced', tags: ['timing', 'wait'] },
    { cat: 'Effects', id: 'quantizedGenerateV2SpawnSpreaderLockToAxis', type: 'checkbox', label: 'Lock to Axis', dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2SpawnSpreaderEnabled'], tier: 'advanced', description: 'Force spawns to occur strictly on the X or Y cardinal axes.', tags: ['axis', 'lock'] },
    { cat: 'Effects', id: 'quantizedGenerateV2SpawnSpreaderPreferCenter', type: 'checkbox', label: 'Prefer Center', dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2SpawnSpreaderEnabled'], tier: 'advanced', description: 'Favor spawning points closer to the seed origin.', tags: ['center', 'bias'] },
    { cat: 'Effects', id: 'quantizedGenerateV2SpawnSpreaderRandomness', type: 'range', label: 'Randomness', min: 0.0, max: 1.0, step: 0.05, dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2SpawnSpreaderEnabled'], tier: 'advanced', transform: v => (v * 100).toFixed(0) + '%', description: 'How far from the center/axis spawns can occur.', tags: ['random', 'range'] },

...
const QuantizedInheritableSettings = [
    ...
    { sub: 'Line Basics', id: 'LineGfxOpacity', type: 'range', label: 'Opacity', min: 0.0, max: 1.0, step: 0.01, tier: 'basic', description: "Overall opacity of all lines.", tags: ['alpha', 'transparency'] },
    ...
    { sub: 'Line Basics', id: 'GlassRefractionOpacity', type: 'range', label: 'Opacity', min: 0.0, max: 1.0, step: 0.01, dep: 'GlassRefractionEnabled', tier: 'advanced', description: "Overall opacity of the refraction lines. 1 is fully opaque, 0 is fully transparent.", tags: ['alpha', 'transparency'] },
...
const generateQuantizedEffectSettings = (prefix, label, action) => {
    ...
    const settings = [
        ...
        { cat: 'Effects', type: 'sub_accordion', label: 'Line Basics', dep: [effectDep, prefix + "Enabled"] },

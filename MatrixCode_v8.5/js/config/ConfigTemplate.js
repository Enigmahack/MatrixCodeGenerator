...
const QuantizedInheritableSettings = [
    ...
    { sub: 'Line Basics', id: 'LineGfxIntensity', type: 'range', label: 'Intensity', min: 0.01, max: 1.0, step: 0.01, tier: 'advanced', tags: ['strength', 'power'] },
...
const ConfigTemplate = [
    ...
    { cat: 'Effects', id: 'quantizedGenerateV2LayerCount', type: 'range', label: 'Layer Count', min: 1, max: 3, step: 1, dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2Enabled'], tier: 'advanced', description: "Number of additional layers to generate (Layer 0 is always base, max 3 additional = 4 total). Layers 2 and 3 are used by Invisible Layer Growth.", tags: ['depth', 'complexity'] },
    ...
    { cat: 'Effects', id: 'quantizedGenerateV2NudgeChance', type: 'range', label: 'Spawn Rate', min: 0.05, max: 1.0, step: 0.05, dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2NudgeEnabled'], tier: 'advanced', transform: v => (v * 100).toFixed(0) + '%', description: 'Probability per tick that a new nudge strip is attempted.', tags: ['chance', 'amount'] },
    { cat: 'Effects', id: 'quantizedGenerateV2MaxNudgeStrips', type: 'range', label: 'Max Strips', min: 1, max: 20, step: 1, dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2Enabled'], tier: 'advanced', description: 'Maximum number of simultaneous nudge strips.', tags: ['limit', 'amount'] },
    { cat: 'Effects', id: 'quantizedGenerateV2NudgeAxisBias', type: 'range', label: 'Axis Bias', min: 0.0, max: 1.0, step: 0.05, dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2NudgeEnabled'], tier: 'advanced', transform: v => v < 0.35 ? 'Vertical (E/W)' : v > 0.65 ? 'Horizontal (N/S)' : 'Mixed', description: 'Controls which axis nudge strips originate from. Left spawns from the vertical axis (x=origin), growing East/West. Right spawns from the horizontal axis (y=origin), growing North/South.', tags: ['direction', 'bias'] },
    { cat: 'Effects', id: 'quantizedGenerateV2NudgeSpacing', type: 'range', label: 'Min Spacing', min: 1, max: 10, step: 1, dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2NudgeEnabled'], tier: 'advanced', description: 'Minimum Manhattan distance between nudge strip origin points. Prevents crowding along the axis.', tags: ['empty', 'gap'] },
    ...
    { cat: 'Effects', id: 'quantizedGenerateV2InvisibleEnabled', type: 'checkbox', label: 'Enabled', dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2Enabled'], tier: 'advanced', description: 'Spawns L2/L3 strips from pre-existing blocks on the axes. L2 originates on the X axis (y=origin) and grows N/S; L3 originates on the Y axis (x=origin) and grows E/W. Requires Layer Count ≥ 3 for L3.', tags: ['hidden', 'background'] },
    { cat: 'Effects', id: 'quantizedGenerateV2InvisibleStartDelay', type: 'range', label: 'Global Start Delay', min: 0, max: 20, step: 1, unit: 'steps', dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2InvisibleEnabled'], tier: 'advanced', description: 'Global steps to wait before invisible strips begin spawning.', tags: ['timing', 'wait'] },
    ...
    { cat: 'Effects', id: 'quantizedGenerateV2InvisibleL2Chance', type: 'range', label: 'L2 Spawn Rate', min: 0.05, max: 1.0, step: 0.05, dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2InvisibleEnabled'], tier: 'advanced', transform: v => (v * 100).toFixed(0) + '%', description: 'Probability per tick that a new L2 rib is attempted.', tags: ['chance', 'amount'] },
    { cat: 'Effects', id: 'quantizedGenerateV2MaxInvisibleL2Strips', type: 'range', label: 'L2 Max Strips', min: 1, max: 200, step: 1, dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2InvisibleEnabled'], tier: 'advanced', description: 'Maximum number of simultaneous L2 strips.', tags: ['limit', 'amount'] },
    { cat: 'Effects', id: 'quantizedGenerateV2InvisibleL2Spacing', type: 'range', label: 'L2 Min Spacing', min: 1, max: 10, step: 1, dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2InvisibleEnabled'], tier: 'advanced', description: 'Minimum Manhattan distance between L2 rib origin points.', tags: ['empty', 'gap'] },
    { cat: 'Effects', id: 'quantizedGenerateV2L2LockEnabled', type: 'checkbox', label: 'Lock to Foundation', dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2InvisibleEnabled'], tier: 'advanced', description: 'If enabled, L2 blocks are constrained by the Layer 0 foundation bounds.', tags: ['limit', 'mask'] },
    { cat: 'Effects', id: 'quantizedGenerateV2L2LockOffset', type: 'range', label: 'L2 Lock Offset', min: 1, max: 10, step: 1, dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2L2LockEnabled'], tier: 'advanced', description: 'Distance (in blocks) from the origin where L2 blocks are locked to the foundation (L0).', tags: ['limit', 'size'] },
    ...
    { cat: 'Effects', id: 'quantizedGenerateV2MaxInvisibleL3Strips', type: 'range', label: 'L3 Max Strips', min: 1, max: 200, step: 1, dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2InvisibleEnabled'], tier: 'advanced', description: 'Maximum number of simultaneous L3 strips.', tags: ['limit', 'amount'] },
    { cat: 'Effects', id: 'quantizedGenerateV2InvisibleL3Spacing', type: 'range', label: 'L3 Min Spacing', min: 1, max: 10, step: 1, dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2InvisibleEnabled'], tier: 'advanced', description: 'Minimum Manhattan distance between L3 vein origin points.', tags: ['empty', 'gap'] },
    { cat: 'Effects', id: 'quantizedGenerateV2L3LockEnabled', type: 'checkbox', label: 'Lock to Foundation', dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2InvisibleEnabled'], tier: 'advanced', description: 'If enabled, L3 blocks are constrained by the Layer 0 foundation bounds.', tags: ['limit', 'mask'] },
    { cat: 'Effects', id: 'quantizedGenerateV2L3LockOffset', type: 'range', label: 'L3 Lock Offset', min: 1, max: 10, step: 1, dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2L3LockEnabled'], tier: 'advanced', description: 'Distance (in blocks) from the origin where L3 blocks are locked to the foundation (L0).', tags: ['limit', 'size'] },
    { cat: 'Effects', id: 'quantizedGenerateV2L3AllowNudges', type: 'checkbox', label: 'Allow Layer Nudges', dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2InvisibleEnabled'], tier: 'advanced', description: 'Let layer 2 moves shift the current location of blocks in the moved quadrant.', tags: ['physics', 'motion'] },
    ...
    { cat: 'Effects', id: 'quantizedGenerateV2L3QuadrantWipeEnabled', type: 'checkbox', label: 'L3 Quadrant Wipe', dep: ['activeQuantizedEffect:quantizedGenerateV2', 'quantizedGenerateV2InvisibleEnabled'], tier: 'advanced', description: 'Automatically removes L3 blocks that extend too far from the foundation.', tags: ['cleaning', 'smart'] },
    ...
    { cat: 'Debug', id: 'layerEnableQuantizedGridCache', type: 'checkbox', label: 'Show Quantized Source Grid', tier: 'advanced', description: 'The raw character grid used to generate lines (Sparse Optimization).', tags: ['cache', 'perf'] },
    { cat: 'Debug', id: 'quantizedSourceGridOffsetX', type: 'range', label: 'Source Grid X Offset', min: -100, max: 100, step: 1, tier: 'advanced', dep: 'layerEnableQuantizedGridCache' },

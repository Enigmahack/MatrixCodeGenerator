...
const QuantizedInheritableSettings = [
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'BlockSpawnerSpawnBias', type: 'select', label: 'Spawn Bias', options: [{label: 'Single Strip', value: 'single'}, {label: 'Wider', value: 'wider'}], dep: 'BlockSpawnerEnabled', tier: 'advanced' },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'SpreadingNudgeChance', type: 'range', label: 'Explorer Chance', min: 0.1, max: 1.0, step: 0.1, dep: 'SpreadingNudgeEnabled', tier: 'advanced', unit: '%', transform: v => (v * 100).toFixed(0) + '%', description: 'The probability of a nudge spreading to adjacent cells.' },
    ...
    { sub: 'V2 Generator (Spawn Behaviors)', id: 'SpreadingNudgeRange', type: 'range', label: 'Explorer Spread Range', min: 0.1, max: 1.0, step: 0.1, dep: 'SpreadingNudgeEnabled', tier: 'advanced', description: 'Maximum distance a nudge can spread from its origin.' },

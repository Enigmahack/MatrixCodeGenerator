...
class UIManager {
    ...
    _generateFXSettings() {
        return [
            ...
            { cat: 'Effects', id: 'quantizedGenerateV2EnablePulseGrowth', type: 'checkbox', label: 'Enable Pulse Growth', dep: 'quantizedGenerateV2Enabled', description: "Replicates the concentric expansion pattern of the Quantized Pulse effect." },
            ...
            { cat: 'Effects', id: 'quantizedGenerateV2EnableRearrange', type: 'checkbox', label: 'Enable Block Rearranging', dep: 'quantizedGenerateV2Enabled', description: "Randomly replaces thin Layer 1 blocks with thicker ones when they extend beyond Layer 0." },
            { cat: 'Effects', id: 'quantizedGenerateV2EnableRNGGrowth', type: 'checkbox', label: 'Enable RNG Generative Growth', dep: 'quantizedGenerateV2Enabled', description: "Enables experimental generative growth algorithm based on movie patterns." },
            { cat: 'Effects', id: 'quantizedGenerateV2SimultaneousSpawns', type: 'range', label: 'Actions Per Step', min: 1, max: 5, step: 1, dep: 'quantizedGenerateV2Enabled', description: "Number of growth actions to attempt in a single step." },

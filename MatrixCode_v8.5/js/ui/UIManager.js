...
class UIManager {
    ...
    _generateAppearanceSettings() {
        return [
            ...
            { cat: 'Appearance', id: 'tracerAttackFrames', type: 'range', label: 'Fade In', min: 0, max: 20, unit: 'fr' },
            { cat: 'Appearance', id: 'tracerHoldFrames', type: 'range', label: 'Hold', min: 0, max: 20, unit: 'fr' },
            { cat: 'Appearance', id: 'tracerReleaseFrames', type: 'range', label: 'Fade Out', min: 0, max: 20, unit: 'fr' },
    ...
    _generateFXSettings() {
        return [
            ...
            { cat: 'Effects', id: 'quantizedPulseSpeed', type: 'range', label: 'Speed', min: 0.1, max: 5, step: 0.1, invert: true, dep: 'quantizedPulseEnabled', description: "Controls the animation update rate. Right = Fast (Update every cycle). Left = Slow (Update every 5 cycles)." },
            ...
            { cat: 'Effects', id: 'quantizedZoomExpansionRate', type: 'range', label: 'Expansion Rate', min: 0.1, max: 5, step: 0.1, invert: true, dep: 'quantizedZoomEnabled', description: "Controls how fast the blocks expand." },
            ...
            { cat: 'Effects', id: 'quantizedZoomInnerColor', type: 'color', label: 'Inner Line Color', dep: 'quantizedZoomEnabled' },
            ...
            { cat: 'Effects', id: 'quantizedGenerateSpeed', type: 'range', label: 'Speed', min: 0.1, max: 5, step: 0.1, invert: true, dep: 'quantizedGenerateEnabled', description: "Controls the animation update rate. Right = Fast (Update every cycle). Left = Slow (Update every 5 cycles)." },
            ...
            { cat: 'Effects', id: 'quantizedGenerateInnerColor', type: 'color', label: 'Inner Line Color', dep: 'quantizedGenerateEnabled' },

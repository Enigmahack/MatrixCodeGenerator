...
class UIManager {
    ...
    _generateAppearanceSettings() {
        return [
            ...
            { cat: 'Appearance', id: 'upwardTracerGlimmerSize', type: 'range', label: 'Glimmer Grid Size', min: 2, max: 6, step: 1, dep: 'upwardTracerEnabled' },
            { cat: 'Appearance', id: 'upwardTracerGlimmerFill', type: 'range', label: 'Glimmer Fill', min: 2, max: 12, step: 1, dep: 'upwardTracerEnabled' },
            { cat: 'Appearance', id: 'upwardTracerGlimmerGlow', type: 'range', label: 'Glimmer Glow', min: 0, max: 50, step: 1, dep: 'upwardTracerEnabled' },
            { cat: 'Appearance', id: 'upwardTracerGlimmerFlicker', type: 'range', label: 'Glimmer Flicker', min: 0.0, max: 1.0, step: 0.05, dep: 'upwardTracerEnabled', transform: v=>(v*100).toFixed(0)+'%' },
    ...
    _generateFXSettings() {
        return [
            ...
            { cat: 'Effects', id: 'quantizedPulseDurationSeconds', type: 'range', label: 'Max Duration', min: 0.5, max: 30, step: 0.1, unit: 's', dep: 'quantizedPulseEnabled' },
            { cat: 'Effects', id: 'quantizedPulseSpeed', type: 'range', label: 'Speed', min: 0.1, max: 1000, step: 0.1, invert: true, dep: 'quantizedPulseEnabled', description: "Controls the animation update rate. Right = Fast (Update every cycle). Left = Slow (Update every 1000 cycles)." },
            ...
            { cat: 'Effects', id: 'quantizedAddDurationSeconds', type: 'range', label: 'Max Duration', min: 0.5, max: 30, step: 0.1, unit: 's', dep: 'quantizedAddEnabled' },
            { cat: 'Effects', id: 'quantizedAddSpeed', type: 'range', label: 'Speed', min: 0.1, max: 1000, step: 0.1, invert: true, dep: 'quantizedAddEnabled', description: "Controls the animation update rate. Right = Fast (Update every cycle). Left = Slow (Update every 1000 cycles)." },
            ...
            { cat: 'Effects', id: 'quantizedRetractDurationSeconds', type: 'range', label: 'Max Duration', min: 0.5, max: 30, step: 0.1, unit: 's', dep: 'quantizedRetractEnabled' },
            { cat: 'Effects', id: 'quantizedRetractSpeed', type: 'range', label: 'Speed', min: 0.1, max: 1000, step: 0.1, invert: true, dep: 'quantizedRetractEnabled', description: "Controls the animation update rate. Right = Fast (Update every cycle). Left = Slow (Update every 1000 cycles)." },
            ...
            { cat: 'Effects', id: 'quantizedClimbDurationSeconds', type: 'range', label: 'Max Duration', min: 0.5, max: 30, step: 0.1, unit: 's', dep: 'quantizedClimbEnabled' },
            { cat: 'Effects', id: 'quantizedClimbSpeed', type: 'range', label: 'Speed', min: 0.1, max: 1000, step: 0.1, invert: true, dep: 'quantizedClimbEnabled', description: "Controls the animation update rate. Right = Fast (Update every cycle). Left = Slow (Update every 1000 cycles)." },
            ...
            { cat: 'Effects', id: 'quantizedZoomFrequencySeconds', type: 'range', label: 'Frequency', min: 10, max: 300, step: 5, unit: 's', dep: 'quantizedZoomEnabled' },
            { cat: 'Effects', id: 'quantizedZoomDurationSeconds', type: 'range', label: 'Max Duration', min: 0.5, max: 30, step: 0.1, unit: 's', dep: 'quantizedZoomEnabled' },
            { cat: 'Effects', id: 'quantizedZoomSpeed', type: 'range', label: 'Expansion Rate', min: 0.1, max: 1000, step: 0.1, invert: true, dep: 'quantizedZoomEnabled', description: "Controls how fast the blocks expand. Right = Fast (Update every cycle). Left = Slow (Update every 1000 cycles)." },
            ...
            { cat: 'Effects', id: 'quantizedZoomBlockWidthCells', type: 'range', label: 'Block Width', min: 1, max: 20, step: 1, dep: 'quantizedZoomEnabled', description: "Width of each block in character cells." },
            ...
            { cat: 'Effects', type: 'accordion_subheader', label: 'Settings', dep: 'quantizedGenerateV2Enabled' },
            ...
            { cat: 'Effects', id: 'quantizedGenerateV2DurationSeconds', type: 'range', label: 'Max Duration', min: 0.5, max: 30, step: 0.1, unit: 's', dep: 'quantizedGenerateV2Enabled' },
            { cat: 'Effects', id: 'quantizedGenerateV2Speed', type: 'range', label: 'Speed', min: 0.1, max: 1000, step: 0.1, invert: true, dep: 'quantizedGenerateV2Enabled', description: "Controls the animation update rate. Right = Fast (Update every cycle). Left = Slow (Update every 1000 cycles)." },

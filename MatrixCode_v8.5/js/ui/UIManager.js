...
class UIManager {
    ...
    _generateFXSettings() {
        return [
            ...
            { cat: 'Effects', id: 'quantizedGenerateV2EnableSubLayerAnchoring', type: 'checkbox', label: 'Anchor sub-layers', dep: 'quantizedGenerateV2Enabled', description: "Restricts sub-layer growth to within a specific distance of the Layer 0 perimeter." },
    ...
    _generateDebugTab() {
        return [
            ...
            { cat: 'Debug', id: 'quantizedLineGfxFadeColor', type: 'color', label: 'Line Fade Color', dep: 'quantizedLineGfxEnabled', description: "The color the lines fade into as they disappear." },
            ...
            { cat: 'Debug', id: 'quantizedLineGfxSaturation', type: 'range', label: 'Saturation', min: 0.0, max: 2.0, step: 0.05, dep: 'quantizedLineGfxEnabled', description: "Boosts color saturation of the lines." },
            { cat: 'Debug', id: 'quantizedLineGfxBrightness', type: 'range', label: 'Brightness', min: 0.0, max: 2.0, step: 0.05, dep: 'quantizedLineGfxEnabled', description: "Scales the overall brightness of the lines." },
            { cat: 'Debug', id: 'quantizedLineGfxAdditiveStrength', type: 'range', label: 'Additive Strength', min: 0.0, max: 2.0, step: 0.05, dep: 'quantizedLineGfxEnabled', description: "Controls how strongly the lines add to the underlying character color." },
            { cat: 'Debug', id: 'quantizedLineGfxSharpness', type: 'range', label: 'Line Sharpness', min: 0.01, max: 0.2, step: 0.01, dep: 'quantizedLineGfxEnabled', description: "Controls the hardness of the line edges." },
            { cat: 'Debug', id: 'quantizedLineGfxRoundness', type: 'range', label: 'Line Roundness', min: 0.0, max: 1.0, step: 0.05, dep: 'quantizedLineGfxEnabled', description: "Applies a circular intensity profile across the line thickness for a rounded look." },
            { cat: 'Debug', id: 'quantizedLineGfxGlowFalloff', type: 'range', label: 'Glow Falloff', min: 0.5, max: 10.0, step: 0.1, dep: 'quantizedLineGfxEnabled', description: "Controls how quickly the glow intensity drops off with distance." },
            { cat: 'Debug', id: 'quantizedLineGfxSampleOffsetX', type: 'range', label: 'Char Sample X Offset', min: -50, max: 50, step: 1, unit: 'px', dep: 'quantizedLineGfxEnabled', description: "Shifts where the line samples character brightness horizontally." },
            { cat: 'Debug', id: 'quantizedLineGfxSampleOffsetY', type: 'range', label: 'Char Sample Y Offset', min: -50, max: 50, step: 1, unit: 'px', dep: 'quantizedLineGfxEnabled', description: "Shifts where the line samples character brightness vertically." },
            { cat: 'Debug', id: 'quantizedLineGfxMaskSoftness', type: 'range', label: 'Char Mask Softness', min: 0.0, max: 5.0, step: 0.1, dep: 'quantizedLineGfxEnabled', description: "Softens the character highlights for a smoother, antialiased look within the lines." },

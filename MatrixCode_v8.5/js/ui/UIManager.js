...
class UIManager {
    ...
    _generateFXSettings() {
        return [
            ...
            { cat: 'Effects', id: 'quantizedBlockWidthCells', type: 'range', label: 'Block Width', min: 1, max: 8, step: 1, dep: 'quantizedPulseEnabled', description: "Width of each block in character cells." },
            { cat: 'Effects', id: 'quantizedBlockHeightCells', type: 'range', label: 'Block Height', min: 1, max: 8, step: 1, dep: 'quantizedPulseEnabled', description: "Height of each block in character cells." },
            ...
            { cat: 'Effects', id: 'quantizedAddBlockWidthCells', type: 'range', label: 'Block Width', min: 1, max: 8, step: 1, dep: 'quantizedAddEnabled', description: "Width of each block in character cells." },
            { cat: 'Effects', id: 'quantizedAddBlockHeightCells', type: 'range', label: 'Block Height', min: 1, max: 8, step: 1, dep: 'quantizedAddEnabled', description: "Height of each block in character cells." },
            ...
            { cat: 'Effects', id: 'quantizedRetractBlockWidthCells', type: 'range', label: 'Block Width', min: 1, max: 8, step: 1, dep: 'quantizedRetractEnabled', description: "Width of each block in character cells." },
            { cat: 'Effects', id: 'quantizedRetractBlockHeightCells', type: 'range', label: 'Block Height', min: 1, max: 8, step: 1, dep: 'quantizedRetractEnabled', description: "Height of each block in character cells." },
            ...
            { cat: 'Effects', id: 'quantizedClimbBlockWidthCells', type: 'range', label: 'Block Width', min: 1, max: 8, step: 1, dep: 'quantizedClimbEnabled', description: "Width of each block in character cells." },
            { cat: 'Effects', id: 'quantizedClimbBlockHeightCells', type: 'range', label: 'Block Height', min: 1, max: 8, step: 1, dep: 'quantizedClimbEnabled', description: "Height of each block in character cells." },
            ...
            { cat: 'Effects', id: 'quantizedZoomBlockWidthCells', type: 'range', label: 'Block Width', min: 1, max: 8, step: 1, dep: 'quantizedZoomEnabled', description: "Width of each block in character cells." },
            { cat: 'Effects', id: 'quantizedZoomBlockHeightCells', type: 'range', label: 'Block Height', min: 1, max: 8, step: 1, dep: 'quantizedZoomEnabled', description: "Height of each block in character cells." },
            ...
            { cat: 'Effects', id: 'quantizedGenerateV2BlockWidthCells', type: 'range', label: 'Block Width', min: 1, max: 8, step: 1, dep: 'quantizedGenerateV2Enabled', description: "Width of each block in character cells." },
            { cat: 'Effects', id: 'quantizedGenerateV2BlockHeightCells', type: 'range', label: 'Block Height', min: 1, max: 8, step: 1, dep: 'quantizedGenerateV2Enabled', description: "Height of each block in character cells." },

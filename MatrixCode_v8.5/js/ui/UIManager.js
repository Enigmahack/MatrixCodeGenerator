    ...
    _generateFXSettings() {
        return [
            ...
            { cat: 'Effects', id: 'quantizedGenerateV2EnableUnfold', type: 'checkbox', label: 'Enable Unfold Growth', dep: 'quantizedGenerateV2Enabled', description: "Enables the unfolding behavior (Copy/Paste frontier)." },
                    ...
                    { cat: 'Effects', id: 'quantizedGenerateV2EnableNudge', type: 'checkbox', label: 'Enable Nudge Growth', dep: 'quantizedGenerateV2Enabled', description: "Enables blocks to nudge away from the center or spines." },

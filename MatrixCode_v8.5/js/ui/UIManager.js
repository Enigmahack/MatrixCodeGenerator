...
class UIManager {
    ...
    _generateFXSettings() {
        return [
            ...
            { cat: 'Effects', id: 'quantizedGenerateV2EnableFallback', type: 'checkbox', label: 'Enable Fallback Growth', dep: 'quantizedGenerateV2Enabled', description: "Allows the system to use default expansion logic if no other behaviors are successful." },
            { cat: 'Effects', id: 'quantizedGenerateV2EnableAutoPruneIslands', type: 'checkbox', label: 'Auto Prune Islands', dep: 'quantizedGenerateV2Enabled', description: "Automatically removes blocks that become detached from the main central mass." },
            ...
            { cat: 'Effects', id: 'quantizedGenerateV2PreventOffscreen', type: 'checkbox', label: 'Prevent Offscreen Behaviors', dep: 'quantizedGenerateV2Enabled', description: "Restricts all growth and movement behaviors to within the visible canvas bounds." },
            ...
            { cat: 'Effects', id: 'quantizedGenerateV2LayerCount', type: 'range', label: 'Layer Count', min: 1, max: 4, step: 1, dep: 'quantizedGenerateV2Enabled', description: "Number of additional layers to generate (Layer 0 is always base)." },

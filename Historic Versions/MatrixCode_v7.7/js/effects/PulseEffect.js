...
class PulseEffect extends AbstractEffect {
                    ...
                    trigger() {
                        ...
                        // Fallback Chars if font has none
                    ...
                    let ox, oy;                if (s.pulseRandomPosition) {
            ...
            update() {
                ...
                // REMOVED: We want the simulation to run in the background so it remains synced when revealed.
                // The visual "hiding" is handled by the override system returning snapshots/gaps.
                if (this.g.cellLocks) {
                    // Ensure locks are cleared if they were previously set
                    // This is a safety measure; SimulationSystem also clears them, but explicit is good.
                    // Actually, SimulationSystem clears them at the end of update(), so we don't need to do anything here.
                }
            }
            ...
            getActiveIndices() {
                // If active, we override the entire screen (either waiting or expanding wave).
                // Returning null signals the renderer to perform a FULL GRID SCAN.
                // This ensures we visit and draw empty cells that the Pulse effect wants to fill (or keep black).
